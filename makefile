...
#FC	=	ftn
# gcc:
FFLAGS  =       -Ofast -std=legacy -ffixed-form -fpp
# intel:
...
SRC 	=	 3dmhd.f 3dmhdset.f 3dmhdsub.f 3dmhd_nml.f

OBJ 	=	 3dmhd.o 3dmhdset.o 3dmhdsub.o 3dmhd_nml.o
